        ...
        <>
            <div className="container m-auto  row flex-wrap"> 
                <div className="col-11 m-auto col-md-4 mt-2 mt-md-3 mb-2 mb-md-3  p-5 shadow rounded ">
                    ...
                    <h6 className="text-center p-2">Wellcome Back MR. </h6>
                    <h3 className="text-center border p-2 shadow bg-white rounded">User Name</h3>
                  ...
                  <div className="col-md-11 m-auto text-center my-3 "> You have no items in your wish list.</div>
                  </div>
            </div>
                    </div>
                <div className=" col-11 m-auto mt-4 mb-4 mb-md-3 mt-md-3 col-md-7 offset-md-1  p-5 shadow rounded">
                    ...
                    <h5> Email : </h5> <h6>salmaahmed@gmail.com</h6>
                    </div>
                    <div className=" mt-4 p-3 shadow rounded bg-white">
                    <h5> Phone : </h5> <h6> +(02) 01000253254 </h6>
                    </div>
                    <div className=" mt-4 p-3 shadow rounded bg-white">
                    <h5> Address : </h5> <h6> Cairo,Geza,university street </h6>
                    </div>
                    <div className=" mt-4 p-3 shadow rounded bg-white">
                    <h5> Orders status : </h5> <h6 className="text-center"> 2 </h6>
                    </div>
                </div>
            </div> 
